    ...
    <div style={{ width: 220, minHeight: '100vh', background: 'white', borderRight: '1px solid #f0f0f0', display: 'flex', flexDirection: 'column', position: 'fixed', left: 0, top: 0, bottom: 0, zIndex: 10, fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif' }}>
      ...
      <nav style={{ flex: 1, padding: '12px 10px' }}>
        ...
        {navItems.map(item => {
          ...
          return (
            <Link key={item.path} to={item.path} style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '9px 10px', borderRadius: 8, textDecoration: 'none', marginBottom: 2, background: isActive ? ACCENT_LIGHT : 'transparent', color: isActive ? ACCENT : '#555', fontWeight: isActive ? 600 : 400, fontSize: 14, transition: 'all 0.15s' }}
