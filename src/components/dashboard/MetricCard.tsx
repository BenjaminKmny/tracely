...
export function MetricCard({ label, value, sub, accent, tooltip, onClick }: MetricCardProps) {
  ...
  return (
    <div
      ...
      onMouseEnter={e => { if (onClick) { e.currentTarget.style.borderColor = ACCENT + '66'; e.currentTarget.style.boxShadow = `0 4px 16px ${ACCENT}15` } }}
      onMouseLeave={e => { if (onClick) { e.currentTarget.style.borderColor = accent ? ACCENT + '33' : '#eee'; e.currentTarget.style.boxShadow = 'none' } }}
    >
      <div style={{ display: 'flex', alignItems: 'center', gap: 4, marginBottom: 6 }}>
        ...
        {onClick && (
          <div style={{ marginLeft: 'auto' }}>
            <svg width="11" height="11" fill="none" viewBox="0 0 24 24" stroke="#ccc">
