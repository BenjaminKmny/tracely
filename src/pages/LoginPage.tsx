    ...
    <div className="min-h-screen bg-stone-950 flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-stone-900 flex-col justify-between p-12">
        ...
        <div className="relative z-10">
          <blockquote className="text-stone-400 text-lg leading-relaxed font-light mb-6">
            "The key is not to prioritize what's on your schedule, but to schedule your priorities."
          </blockquote>
          <cite className="text-stone-600 text-sm not-italic">— Stephen Covey</cite>
        </div>

        {/* Stats */}
        <div className="relative z-10 flex gap-8">
          {[
            { value: '12k+', label: 'Tasks tracked' },
            { value: '98%', label: 'Uptime' },
            { value: '4.9★', label: 'User rating' },
          ].map(({ value, label }) => (
            <div key={label}>
              <div className="text-amber-400 font-semibold text-xl">{value}</div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-sm">
          ...
          <h1 className="text-stone-100 text-2xl font-semibold mb-1">Welcome back</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                <label className="block text-stone-400 text-xs font-medium">Password</label>
                <Link to="/forgot-password" className="text-xs text-stone-500 hover:text-amber-400 transition-colors">
                  Forgot password?
                </Link>
              </div>
              <input
